...
contract Trading {
        ...
        returns(address, uint256, uint256, bytes32)
    {
        ...
        return (trade.tradePostedBy, trade.ticketTokenId , trade.price, trade.status);
    }
    
    
    function openTrade(uint256 _ticketTokenId, uint256 _price)
        public
        virtual
    {
    ...
    payable
    {
      ...
      require(msg.value == trade.price, "value not equal to price");
      
      payable(trade.tradePostedBy).transfer(msg.value);
      ticketInstance.transferFrom(address(this), msg.sender, trade.ticketTokenId);
...
contract TicketBookingSystem {
    ...
    Poster public posterInstance;
    Trading public tradingInstance;
    ...
    constructor(
        ...
        tradingInstance = new Trading(ticketInstance);
    ...
    */
    ...
    function getTradeCounter() public view returns (uint256 tradeCounter){
        
        return tradingInstance.tradeCounter();
